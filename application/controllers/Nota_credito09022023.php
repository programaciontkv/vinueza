		...
		foreach ($cns as $rst_det) {
			$n++;
		        ...
		        $detalle.="<tr>
                                            ...
                                            <td>
                                                <input type ='text' size='15' style='text-align:right' class='form-control decimal' id='descuento$n' name='descuento$n'  value='".str_replace(',', '', number_format($rst_det->dfc_porcentaje_descuento, $dec))."' lang='$n' onchange='calculo(this)'   />
                                            </td>
                                            <td $w_movil>
                                                <input type ='text' size='7' style='text-align:right' class='form-control decimal' id='descuent$n' name='descuent$n'  value='".str_replace(',', '', number_format($rst_det->dfc_val_descuento, $dec))."' lang='$n'  />
                                            </td>
