...
class Nota_credito extends CI_Controller {
	...
	public function anular($id,$num,$opc_id){
		if($this->permisos->rop_eliminar){
			$rst_chq=$this->cheque_model->lista_cheque_nota($id);
			if(empty($rst_chq)){
				$rst_opc=$this->opcion_model->lista_una_opcion($opc_id);
				$rst_ncr=$this->nota_credito_model->lista_una_nota($id);
				$up_dt=array('mov_estado'=>3);
				...
				if($this->nota_credito_model->update($id,$up_dtf)){
					...
					$this->nota_cheque_model->update_chq_nota($id,$up_chq);
	...
	public function show_frame($id,$opc_id){
    	...
    	if($permisos->rop_reporte){
    		$data=array(
					...
					'direccion'=>"nota_credito/show_pdf/$id/$opc_id/0",
				);
			$this->load->view('layout/header',$this->menus());
			$this->load->view('layout/menu',$this->menus());
    ...
    public function show_pdf($id,$opc_id,$correo){
    		$rst=$this->nota_credito_model->lista_una_nota($id);
		...
		foreach ($cns as $rst_det) {
			$n++;
		        ...
		        $detalle.="<tr>
                                            ...
                                            <td><input type ='text' size='10'  style='text-align:right' class='form-control' id='pro_descripcion$n' name='pro_descripcion$n' value='$rst_det->mp_c' lang='$n' readonly/></td>
                                            </td>
                                            <td><input type ='text' size='10'  style='text-align:right' class='form-control' id='pro_referencia$n' name='pro_referencia$n' value='$rst_det->mp_d' lang='$n' readonly/>
                                            ...
                                            <td><input type ='text' size='7' style='text-align:right' class='form-control decimal' id='pro_precio$n' name='pro_precio$n' value='".str_replace(',', '', number_format($rst_det->dfc_precio_unit, $dec))."' lang='$n' onchange='calculo(this)' readonly /></td>
                                            <td>
                                                <input type ='text' size='7' style='text-align:right' class='form-control decimal' id='descuento$n' name='descuento$n'  value='".str_replace(',', '', number_format($rst_det->dfc_porcentaje_descuento, $dec))."' lang='$n' onchange='calculo(this)'  readonly />
                                            </td>
                                            <td>
                                            ...
                                            <td><input type='text' id='iva$n' name='iva$n' size='5' style='text-align:right' class='form-control' value='$rst_det->dfc_iva' lang='$n' readonly /></td>
                                            ...
                                            <td>
                                                <input type ='text' size='9' style='text-align:right' class='form-control' id='valor_total$n' name='valor_total$n'  value='".str_replace(',', '', number_format($rst_det->dfc_precio_total, $dec))."' readonly lang='$n'/>
    ...
    function envio_mail($datos){
        ...
        $this->email->from($cred[3], 'TIKVASYST SAS');
        ...
        $this->email->cc('crisrosxx@gmail.com');
        ...
        $datos_sms = "<html>
             ...
             <body>
               <table width='100%'>
                  ...
                  <tr><td>Has recibido un nuevo documento". utf8_decode('electrónico').".</td></tr>
                  <tr><td></br></br> </td></tr>
                  <tr><td></br></br> </td></tr>
                  <tr><td>Fecha: $datos->fecha </td></tr>
                  <tr><td>Emisor: $datos->emisor </td></tr>
                  <tr><td>Tipo de Documento: $datos->tipo </td></tr>
                  <tr><td>".utf8_decode('Número')." de Documento: $datos->numero </td></tr>
                 ...
                 <tr><td>Adjuntamos el comprobante en formato PDF y XML </td></tr>
                   <tr><td></br></br> </td></tr>
                    ...
                    <tr><td></br></br> </td></tr>
                 <tr>
                      <td style='font-size:16px'>FACTURACION ELECTRONICA POR TIKVA SYST S.A.S</td>
                  </tr>
                  <tr><td></br></br> </td></tr>
                  ...
                  <tr>   
                       <td style='font-size:12px'>
                        ...
                        <img src='$img_whatsapp' width='20px'> 0994329166 
                        <img src='$img_telefono' width='20px'>(02) 333-2926 
                      </td>
                  </tr>
                  <tr><td style='font-size:10px'>Copyright &copy; 2018 Todos los derechos reservados <a href='https://www.tivkas.com'>TIKVA SYST S.A.S</a></td></tr>
               </table>
             </body>
           </html>";
