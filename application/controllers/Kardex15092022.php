				...
				//totales
					if($grup!=$kardex->pro_id && $n!=1){
						...
						$detalle.="<tr class='success'>
								...
								<td class='total' style='font-weight: bolder;'> </td>
								<td class='total' style='font-weight: bolder;'> </td>
								<td class='total' style='font-weight: bolder;' style='mso-number-format:$a'> $g_cod</td>
								<td class='total' style='font-weight: bolder;'> $g_desc</td>
								<td class='total' style='font-weight: bolder;'> $g_uni</td>
				...
				//saldo inicial 
					if($grup!=$kardex->pro_id){
						...
						$detalle.="<tr>
								...
								<td class='inicial' style='font-weight: bolder;'> </td>
								<td class='inicial' style='font-weight: bolder;'> </td>
								<td class='inicial' style='mso-number-format:$a; font-weight: bolder;'> $kardex->mp_c</td>
								<td class='inicial' style='font-weight: bolder;'> $kardex->mp_d</td>
								<td class='inicial' style='font-weight: bolder;'> $kardex->mp_q</td>
							...
							$detalle.="<tr>
								...
								<td> $kardex->cli_raz_social</td>
								<td style='mso-number-format:$a'> $kardex->mp_c</td>
								<td> $kardex->mp_d</td>
								<td> $kardex->mp_q</td>
								<td> $kardex->trs_descripcion</td>
