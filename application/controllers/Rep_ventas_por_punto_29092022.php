...
class Rep_ventas_por_punto extends CI_Controller {
	...
	public function index($opc_id){
			...
			foreach ($cns_facturas as $factura) {
				...
				if($gr!=$factura->emi_id && $n!=1){
					$detalle.="<tr class='subtotal'>
								<td>TOTAL $gr_nm</td>";
					if($ventas=='checked'){			
						$detalle.="<td class='number'>".number_format($s_nf)."</td>
					...
					if($devoluciones=='checked'){			
						$detalle.="<td class='number'>".number_format($s_nc)."</td>
								<td class='number'>".number_format($s_nsub12,$dec)."</td>
								<td class='number'>".number_format($s_nsub0,$dec)."</td>
								<td class='number'>".number_format($s_nsub,$dec)."</td>
								<td class='number'>".number_format($s_niva,$dec)."</td>
								<td class='number'>".number_format($s_ntotal,$dec)."</td>
								<td class='number'>".number_format($s_tvd,$dec)."</td>";
					}
					if($cajab=='checked'){			
						$detalle.="<td class='number'>".number_format($s_tc,$dec)."</td>
								<td class='number'>".number_format($s_td,$dec)."</td>
								<td class='number'>".number_format($s_ch,$dec)."</td>
								<td class='number'>".number_format($s_ef,$dec)."</td>
								<td class='number'>".number_format($s_crt,$dec)."</td>
								<td class='number'>".number_format($s_tran,$dec)."</td>
								<td class='number'>".number_format($s_ret,$dec)."</td>
								<td class='number'>".number_format($s_not,$dec)."</td>
								<td class='number'>".number_format($s_cre,$dec)."</td>
								<td class='number'>".number_format($s_tcaja,$dec)."</td>";
					}			
					$detalle.="</tr>";
				...
				if($vendedor=='checked'){
					...
					if($ventas=='checked'){
						$detalle.= "<td class='number'>".number_format($factura->nf)."</td>
									...
									<td class='number'>".number_format($factura->ice,$dec)."</td>
									<td class='number'>".number_format($factura->iva,$dec)."</td>
									<td class='number'>".number_format($factura->total,$dec)."</td>";
					}	
					if($devoluciones=='checked'){			
						$detalle.= "<td class='number'>".number_format($nota->nc)."</td>
									<td class='number'>".number_format($nota->subtotal12,$dec)."</td>
									<td class='number'>".number_format($nota->subtotal_sin_iva,$dec)."</td>
									<td class='number'>".number_format($nota->subtotal,$dec)."</td>
									<td class='number'>".number_format($nota->iva,$dec)."</td>
									<td class='number'>".number_format($nota->total,$dec)."</td>
									<td class='number'>".number_format($tvd,$dec)."</td>";
					}				
					if($cajab=='checked'){			
						$detalle.= "<td class='number'>".number_format($caja->tc,$dec)."</td>
									<td class='number'>".number_format($caja->td,$dec)."</td>
									<td class='number'>".number_format($caja->cheque,$dec)."</td>
									<td class='number'>".number_format($caja->efectivo,$dec)."</td>
									<td class='number'>".number_format($caja->certificados,$dec)."</td>
									<td class='number'>".number_format($caja->transferencia,$dec)."</td>
									<td class='number'>".number_format($caja->retencion,$dec)."</td>
									<td class='number'>".number_format($caja->nc,$dec)."</td>
									<td class='number'>".number_format($caja->credito,$dec)."</td>
									<td class='number'>".number_format($tcaja,$dec)."</td>";
					}				
				$detalle.= "</tr>";
				}
				$gr=$factura->emi_id;
		...
		$detalle.="<tr class='total'>
								<td>TOTAL</td>";
				if($ventas=='checked'){						
					$detalle.="	<td class='number'>".number_format($t_nf)."</td>
								...
								<td class='number'>".number_format($t_ice,$dec)."</td>
								<td class='number'>".number_format($t_iva,$dec)."</td>
								<td class='number'>".number_format($t_total,$dec)."</td>";
				}				
				if($devoluciones=='checked'){						
					$detalle.="<td class='number'>".number_format($t_nc)."</td>
								<td class='number'>".number_format($t_nsub12,$dec)."</td>
								<td class='number'>".number_format($t_nsub0,$dec)."</td>
								<td class='number'>".number_format($t_nsub,$dec)."</td>
								<td class='number'>".number_format($t_niva,$dec)."</td>
								<td class='number'>".number_format($t_ntotal,$dec)."</td>
								<td class='number'>".number_format($t_tvd,$dec)."</td>";
				}				
				if($cajab=='checked'){						
					$detalle.="<td class='number'>".number_format($t_tc,$dec)."</td>
								<td class='number'>".number_format($t_td,$dec)."</td>
								<td class='number'>".number_format($t_ch,$dec)."</td>
								<td class='number'>".number_format($t_ef,$dec)."</td>
								<td class='number'>".number_format($t_crt,$dec)."</td>
								<td class='number'>".number_format($t_tran,$dec)."</td>
								<td class='number'>".number_format($t_ret,$dec)."</td>
								<td class='number'>".number_format($t_not,$dec)."</td>
								<td class='number'>".number_format($t_cre,$dec)."</td>
								<td class='number'>".number_format($t_tcaja,$dec)."</td>";
				}				
					$detalle.="</tr>";	
