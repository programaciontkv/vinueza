...
class caja extends CI_Controller {
	...
	public function guardar(){
		...
		$cja_sec_liquidacion = $this->input->post('cja_sec_liquidacion');
		...
		$this->form_validation->set_rules('cja_sec_liquidacion','Secuencial Inicia Liquidacion COmpras','required');
		...
		if($this->form_validation->run()){
			$data=array(
					    ...
					    'cja_sec_liquidacion'=>$cja_sec_liquidacion,
