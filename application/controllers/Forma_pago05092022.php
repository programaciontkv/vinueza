...
class Forma_pago extends CI_Controller {
	...
	public function guardar(){
		...
		$fpg_precio = $this->input->post('fpg_precio');
		...
		$this->form_validation->set_rules('pln_id','Cuenta contable','required');
	...
	public function editar($id){
		if($this->permisos->rop_actualizar){
			$data=array(
						...
						'estados'=>$this->estado_model->lista_estados_modulo($this->permisos->opc_id),
						'cuentas'=>$this->forma_pago_model->lista_plan_cuentas_estado('1'),
						'forma_pago'=>$this->forma_pago_model->lista_una_forma_pago($id),
	...
	public function actualizar(){
		...
		$forma_pago_act=$this->forma_pago_model->lista_una_forma_pago($id);
