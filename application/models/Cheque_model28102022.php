...
class Cheque_model extends CI_Model {
	...
	public function lista_facturas_cliente($id){
		$this->db->select('f.fac_id,f.fac_fecha_emision, pag_fecha_v, f.fac_numero, f.fac_nombre, f.fac_identificacion,f.fac_total_valor,pago,saldo,fac_estado,f.cli_id');
