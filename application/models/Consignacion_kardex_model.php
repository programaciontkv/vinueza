...
class Consignacion_kardex_model extends CI_Model {

	
	public function lista_kardex_buscador($text,$ids,$f1,$f2,$txt){
		$this->db->select("m.*,e.est_descripcion, c.cli_raz_social, t.trs_descripcion,t.trs_operacion, p.id, p.mp_a,p.mp_b,p.mp_c,p.mp_d,p.mp_q,em.emi_nombre" );
