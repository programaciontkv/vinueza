...
class Factura_model extends CI_Model {
	...
	public function lista_clave_acceso($num, $cli){
		...
		$query="  SELECT '1' as tipo,fac_id as id, fac_numero as numero, fac_fecha_emision as fecha,fac_clave_acceso as clave, fac_estado_aut as estado, fac_autorizacion as autorizacion  FROM erp_factura where fac_clave_acceso='$num' and fac_identificacion='$cli'
		    union
