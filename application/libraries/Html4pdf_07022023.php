...
class Html4pdf {
	...
	function output($option) 
	{
		...
		$canvas->page_text(35, 15, $this->nombre, $font, 8, array(0, 0, 0));
		$canvas->page_text(35, 25, $this->identificacion, $font, 8, array(0, 0, 0));
		$canvas->page_text(35, 35, $this->direcion, $font, 8, array(0, 0, 0));
		$canvas->page_text(35, 45, $this->telefono, $font, 8, array(0, 0, 0));
