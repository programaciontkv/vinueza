...
<section class="content">
                          ...
                          <tr>
                            ...
                            <tr>
                              <td><label>Origen:</label></td>
                                <td>
                                <div class="form-group <?php if(form_error('org')!=''){ echo 'has-error';}?> ">
                                  <input type="text" class="form-control" name="org" id="org" value="<?php if(validation_errors()!=''){ echo set_value('org');}else{ echo $egreso->org;}?>" readonly>
                                    <?php echo form_error("org","<span class='help-block'>","</span>");?>
                                    <input type ="hidden" id="org_cli" name="org_cli" value="<?php echo $egreso->org_cli?>" />
                                    <input type ="hidden" id="org_bod" name="org_bod" value="<?php echo $egreso->org_bod?>" />
                                  </div>
                              </td>
                              <td><label>Destino:</label></td>
                                <td>
                                <div class="form-group <?php if(form_error('des')!=''){ echo 'has-error';}?> ">
                                  <input type="text" class="form-control" name="des" id="des" value="<?php if(validation_errors()!=''){ echo set_value('des');}else{ echo $egreso->des;}?>" list='lista_locales' onchange="traer_local()">
                                    <?php echo form_error("des","<span class='help-block'>","</span>");?>
                                    <input type ="hidden" size="20"  id="des_cli" name="des_cli"  value="" />
                                    <input type ="hidden" size="20"  id="des_bod" name="des_bod" value="" />
                                  </div>
                              </td>
                          ...
                          <table class="table table-bordered table-striped" id="tbl_detalle">
                            <thead>
                              <tr>
                                ...
                                <th>Inventario</th>
                                <th>Cantidad</th>
                                <th hidden>Cost. Unit</th>
                                <th hidden>Cost. Tot</th>
                                <th></th>
                                <th></th>
                              </tr>
                            </thead>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th hidden class="totales" id="tu"></th>
                                    <th hidden class="totales" id="tt"></th>
                                </tr>
    ...
    <?php
    if(!empty($cns_loc)){
      foreach ($cns_loc as $rst_loc) {
         ?>
        <option value="<?php echo $rst_loc->emi_id?>"><?php echo $rst_loc->emi_nombre?></option>
      <?php 
      }
    }
    ?>
    ...
    <script>
      ...
      function traer_cliente(){
              $.ajax({
                    ...
                    url: base_url+"consignacion_egreso/traer_cliente/"+cli_nombre.value,
                    type: 'JSON',
                    dataType: 'JSON',
                    success: function (dt) {
                        if(dt!=""){
            ...
            function traer_local(){
              ...
              $.ajax({
                    ...
                    url: base_url+"consignacion_egreso/traer_local/"+des.value,
                    type: 'JSON',
                    dataType: 'JSON',
                    success: function (dt) {
                        if(dt!=""){
                          $('#des').val(dt.emi_nombre);
                          $('#des_bod').val(dt.emi_id);
            ...
            function load_producto(j) {
                ...
                $.ajax({
                  beforeSend: function () {
                    ...
                    url: base_url+"consignacion_egreso/load_producto/"+vl+"/"+emi_id.value+"/"+cli_id.value,
                    type: 'JSON',
                    dataType: 'JSON',
                    success: function (dt) {
