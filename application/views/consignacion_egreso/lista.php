<section class="content-header">
	<form id="exp_excel" style="float:right;padding:0px;margin: 0px;" method="post" action="<?php echo base_url();?>consignacion_egreso/excel/<?php echo $permisos->opc_id?>/<?php echo $fec1?>/<?php echo $fec2?>" onsubmit="return exportar_excel2()"  >
		...
		<div class="box box-body">
			...
			<div class="row">
				...
				<div class="col-md-2">
						...
						<a href="<?php echo base_url();?>consignacion_egreso/nuevo/20/<?php echo $opc_id?>" class="btn btn-success boton"><span class="fa fa-plus"></span>Nueva Consignacion</a>
					...
					<table id="tbl_list" class="table table-bordered table-list table-hover table-striped" width="100%">
						...
						?>
							<tr>
								...
								<td><?php echo utf8_decode($egreso->emi_nombre)?></td>
								<td><?php echo utf8_decode($egreso->cli_raz_social)?></td>
...
<script type="text/javascript">
	function envio(id,opc){
		if(opc==0){
			...
			url="<?php echo base_url();?>consignacion_egreso/show_frame/"+id+"/<?php echo $permisos->opc_id?>";
		}
