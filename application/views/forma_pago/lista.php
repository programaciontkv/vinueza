			...
			<div class="row">
				<div class="col-md-12">
					<table id="tbl_list" class="table table-bordered table-list table-hover">
						<thead>
							<!-- <th>No</th> -->
							<th class="hidden-mobile" >Codigo SRI</th>
						...
						?>
							<tr>
								<!-- <td><?php echo $n?></td> -->
								<td class="hidden-mobile" style="mso-number-format:'@'"><?php echo $forma_pago->fpg_codigo?></td>
								<td class="hidden-mobile"><?php echo $forma_pago->fpg_descripcion?></td>
								<td ><?php echo $forma_pago->fpg_descripcion_sri?></td>
								<td class="hidden-mobile"><?php echo $tipo?></td>
							<!-- 	<td><?php echo $forma_pago->banco?></td>
								...
								<td>
									 ...
									 <img width="40px" height="40px" onclick="cambiar_es(2,<?php echo $forma_pago->fpg_id?>)" src="../imagenes/activo.png"> 
								...
								?>
								<td>
									 <img width="40px" height="40px" onclick="cambiar_es(1,<?php echo $forma_pago->fpg_id?>)" src="../imagenes/inactivo.png"> 
								...
								<td align="center">
									<div class="btn-group">
										...
										?>
											<a href="<?php echo base_url();?>forma_pago/editar/<?php echo $forma_pago->fpg_id?>/<?php echo $permisos->opc_id?>" class="btn btn-primary"> <span class="fa fa-edit"></span></a>
										<?php 
										}
