...
<section class="content">
      <div class="row">
                    ...
                    <tr>
                      ...
                      <td colspan="4" class="col-sm-1">
                        ...
                        ?>
                          <div class="row" >
                               <div class="col-sm-4">
                                 <input style="width:105px" type="button" class="btn btn-primary" onclick="verificar_cedula('9999999999')"  name="" value="Consumidor final ">
        ...
        <td><input type="button" name="add1" id="add1" onclick="validar('#tbl_pagos','1')" lang="1" class="btn btn-primary " value="Agregar">
                                ...
                                <td>
                                  <select name="pag_plazo<?php echo $m?>" id="pag_plazo<?php echo $m?>" class="form-control" lang="1" <?php echo $dis_contado?>>
                                    <option value='0'>SELECCIONE</option>
                                  </select>
                                  <script>
                     ...
                     ?>
                      ...
                      <td  ><input type="<?php echo $ocultar ?>" name="add<?php echo $m?>" id="add<?php echo $m?>" onclick="validar('#tbl_pagos','1')" lang="<?php echo $m?>" class="btn btn-primary " value="Agregar">
            </td>
                                  <td onclick="elimina_fila(this, '#tbl_pagos','1')" align="center" ><span class="btn btn-danger fa fa-trash"></span></td>
                              </tr>
                              <?php
                          ...
                          <table class="table table-bordered table-striped" id="tbl_detalle">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          <input type ="text" size="7"  style="text-align:right" id="det_cantidad" name="det_cantidad"  value="1" lang="1" onchange="calculo_encabezado(this)" class="form-control decimal" />
                                        </td>
                                        <td>
            ...
            function verificar_cedula(cedula) {
              ...
              // }else{
                ...
                if (cedula=='9999999999') {
                  $('#ped_ruc_cc_cliente').val('9999999999');
                }
              // }
