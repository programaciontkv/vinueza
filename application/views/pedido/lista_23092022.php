	...
	<div class="box box-solid">
		<div class="box box-body">
			...
			<div class="col-sm-2">
					...
					?>
						<a href="<?php echo base_url();?>pedido/nuevo/<?php echo $permisos->opc_id?>" class="btn btn-success btn-flat"><span class="fa fa-plus"></span> Crear pedido</a>
					<?php 
					}
					?>
				</div>
					...
					<table id="tbl_list" class="table table-bordered table-list table-hover">
						...
						?>
							<tr>
								...
								<td >
									<?php 
									if($pedido->ped_estado == 17 || $pedido->ped_estado == 7 || $pedido->ped_estado == 15 || $pedido->ped_estado == 19){
									?>
								...
								<td align="center">
									<div class="btn-group">
										...
										?>
											<a href="<?php echo base_url();?>pedido/show_frame/<?php echo $pedido->ped_id?>/<?php echo $permisos->opc_id?>" title="PDF Pedido" class="btn btn-warning"> <span class="fa fa-file-pdf-o"></span></a>
										<?php 
										}
										if($permisos->rop_actualizar && ($pedido->ped_estado == 7 || $pedido->ped_estado == 14 )){
										?>
											<a title="Editar Pedido"  href="<?php echo base_url();?>pedido/editar/<?php echo $pedido->ped_id?>/<?php echo $opc_id?>" class="btn btn-primary"> <span class="fa fa-edit"></span></a>
										<?php 
										}
