		...
		<div class="box box-body">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					?>
						<a href="<?php echo base_url();?>cliente/nuevo" class="btn btn-success btn-flat"><span class="fa fa-plus"></span> Crear Cliente </a>
					<?php 
					}
					?>
				</div>	
							...
							<tr>
								...
								<td align="center">
									<div class="btn-group">
										...
										?>
											<a href="<?php echo base_url();?>cliente/editar/<?php echo $cliente->cli_id?>" title="Editar Cliente/Proveedor" class="btn btn-primary"> <span class="fa fa-edit"></span></a>
										<?php 
										}
