...
<section class="content">
          ...
          <div class="box box-primary" >
            <form role="form" action="<?php echo $action?>" method="post" autocomplete="off">
                        ...
                        <tr>
                                ...
                                <td>      
                                  <div class="form-group <?php if(form_error('cli_email')!=''){ echo 'has-error';}?>">
                                    <label>Email:</label>
                                    <input type="email" class="form-control" name="cli_email" value="<?php if(validation_errors()!=''){ echo set_value('cli_email');}else{ echo $cliente->cli_email;}?>">
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url();?>cliente" class="btn btn-default">Cancelar</a>
              </div>
    ...
    <script type="text/javascript">
      ...
      function cod() {
            ...
            function categoria() {
                if ($('#cli_categoria1').prop('checked') == true) {
                    //$('#cli_nombres').prop('hidden',false);
                    //$('#cli_apellidos').prop('hidden',false);
