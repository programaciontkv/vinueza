						...
						?>
							<tr>
								...
								<td>
									 ...
									 <img title="Inactivar Cliente" width="40px" height="40px" onclick="cambiar_es(2,<?php echo $cliente->cli_id?>)" src="../imagenes/activo.png"> 
								...
								?>
								<td>
									 <img title="Activar Cliente" width="40px" height="40px" onclick="cambiar_es(1,<?php echo $cliente->cli_id?>)" src="../imagenes/inactivo.png"> 
