						...
						?>
							...
							<!-- 	<td><?php echo $producto->est_descripcion?></td> -->
								...
								<td>
									 ...
									 <img title="Inactivar Producto" width="40px" height="40px" onclick="cambiar_es(2,<?php echo $producto->id?>)" src="../imagenes/activo.png"> 
								...
								?>
								<td>
									 <img title="Activar Producto" width="40px" height="40px" onclick="cambiar_es(1,<?php echo $producto->id?>)" src="../imagenes/inactivo.png"> 
								...
								<td align="center">
									...
									<!-- 	<a href="<?php echo base_url();?>producto_comercial/eliminar/<?php echo $producto->id?>/<?php echo $producto->mp_c?>" title="Eliminar producto terminado " class="btn btn-danger btn-remove"><span class="fa fa-trash"></span></a> -->
										...
										?>
										<a href="<?php echo base_url();?>producto_comercial/show_frame/<?php echo $producto->id?>/<?php echo $permisos->opc_id?>" title="Etiqueta producto " class="btn btn-success btn-success"><span class="fa fa-barcode"></span></a>
...
<script type="text/javascript">
	...
	function ver_img(id){
		...
		$.ajax({
                    ...
                    Swal.fire("Error!", "Ingrese una imagen del producto.!", "error");
