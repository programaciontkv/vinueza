...
<p align="left"><img src="<?php echo base_url().'imagenes/'.$logo?>" width="250px" height="100px"> </p>
  <p align="center" class="titulo"><strong>Detalle de Cobros</strong></p>
  <table  id="tbl_list" class="table table-bordered table-list table-hover" width="100%" >
      <tr>
          <td>
              <strong>Cliente:</strong>  <?php echo  $cheque->cli_raz_social?>
          </td>
          
      </tr>
      <tr>
          <td>
              <strong>Tipo Pago:</strong> <?php echo $tp?>
          </td>
          <td>
            <?php
      ...
      <tr>
          <td>
              <strong>Banco :</strong> <?php echo $cheque->pln_descripcion?>
          </td>
            <?php
                if($cheque->chq_estado_cheque=='3' || $cheque->chq_estado_cheque == '12')
                {
