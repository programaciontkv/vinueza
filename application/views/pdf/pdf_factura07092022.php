    ...
    <tr>
        ...
        <td rowspan="2" width="52%">
            <table id="encabezado2" width="100%">
                ...
                <tr>
                    <td><strong>Fecha de Emision: </strong><?php echo $factura->fac_fecha_emision?></td>
                </tr>    
                <tr>
                ...
                <tr>
                    <td><strong>Emision: </strong>Normal</td>
                </tr>    
                <tr>
    ...
    <tr>    
        <td width="48%" valign="bottom">
            <table id="encabezado1" width="98%">
                ...
                <tr>
                    <td><?php echo ucwords(strtolower($factura->emp_direccion))?></td>
                </tr>
                <tr>
                    <td colspan="2"><strong>Telefono: </strong> <?php echo ucwords(strtolower($factura->emp_telefono))?></td>
                    <th></th>
                </tr> 
                <tr>
                ...
                <tr>
                    <th colspan="2">Agentes de Retencion</th>
                </tr>    
                <tr>
                    <th colspan="2">Segun Resolucion NAC-DNCRASC20-00000001</th>
                </tr>    
            </table>
        </td>
        <tr>
    ...
    <tr>
        <td colspan="2">
            <table id="encabezado3" width="100%">
                <tr>
                    <td><strong>Razon Social: </strong> <?php echo ucwords(strtolower($factura->fac_nombre))?></td>
                    
                </tr>    
                <tr>
                    <td><strong>Email: </strong><?php echo strtolower($factura->cli_email)?></td>
                    <td><strong>Cedula/RUC: </strong><?php echo $factura->fac_identificacion?></td>
                </tr>    
                <tr>
                    <td><strong>Direccion: </strong><?php echo ucwords(strtolower($factura->fac_direccion))?></td>
                    <td><strong>Telefono: </strong><?php echo $factura->fac_telefono?></td>
                </tr>
    ...
    <tr>
        <td colspan="2">
            <table id="detalle" width="100%" class="table table-bordered table-list table-hover table-striped">
                ...
                <tbody>
                    <tr>
                        <td id="info" colspan="3" rowspan="9" valign="top">
                            <table>
                                <tr>
                                    <td><strong>Informacion Adicional</strong></td>
                                </tr>
                                <tr>
                                    <td><strong>Observaciones: </strong> <?php echo ucfirst(strtolower($factura->fac_observaciones))?> </td>
                                </tr>
