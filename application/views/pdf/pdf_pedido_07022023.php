  ...
  <table width="100%">
    <tr>
        <td colspan="3" width="100%">
            <table  width="100%">
                <tr><td><strong><?php echo $pedido->emp_nombre; ?> </strong>  </td> 
                <td rowspan="4" width="20%"><img src="<?php echo base_url().'imagenes/'.$pedido->emp_logo?>"  width="130px" height="70px"></td>
                 </tr>
                <tr><td><?php echo $pedido->emp_identificacion; ?> </td>  </tr>
                <tr><td><?php echo $pedido->emp_ciudad."-".$pedido->emp_pais; ?> </td>  </tr>
                <tr><td><?php echo "TELEFONO: " . $pedido->emp_telefono ?> </td>  </tr>
    ...
    <tr >
        ...
        <td colspan="2"  >
            <div style="text-align:center;">
                <p class="titulo2"><?php echo utf8_encode( 'Pedido N°:')?> <?php echo $pedido->ped_num_registro?> </p>
            </div>
