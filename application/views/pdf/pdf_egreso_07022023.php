       ...
       <tr>
        ...
        <td colspan="3" width="100%">
            <table id="encabezado1" width="100%">
                <tr><td><strong><?php echo $egreso->emp_nombre; ?> </strong>  </td> 
                <td rowspan="4" width="20%"><img src="<?php echo base_url().'imagenes/'.$egreso->emp_logo?>"  width="130px" height="70px"></td>
                 </tr>
                <tr><td><?php echo $egreso->emp_identificacion; ?> </td>  </tr>
                <tr><td><?php echo $egreso->emp_ciudad."-".$egreso->emp_pais; ?> </td>  </tr>
                <tr><td><?php echo "TELEFONO: " . $egreso->emp_telefono ?> </td>  </tr>
    ...
    <tr>
        <td colspan="3">
            <table id="encabezado1" width="100%">
                ...
                <tr>
                    <th class="titulo" style="text-align: right;"><?php echo utf8_encode('Egreso N°: ')?>
