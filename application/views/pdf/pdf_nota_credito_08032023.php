    ...
    <tr>
        <td colspan="2">
            <table id="encabezado3" width="100%">
                ...
                <tr>
                    <th colspan="2" style="text-align:center">______________________________________________________________________________________________________</th>
                </tr>   
                <tr>
            ...
            <table id="detalle" width="95%">
                ...
                <tbody>
                    ...
                    ?>
                    <tr>
                        <td width="50px"><?php echo $det->pro_codigo?></td>
                        <td width="50px" class="numerico"><?php echo number_format($det->cantidad,$dcc)?></td>
                        <td style="width: 10px !important;"><?php echo ucwords(strtolower($det->pro_descripcion))?></td>
                        <td width="70px" class="numerico"><?php echo number_format($det->pro_precio,$dec)?></td>
                        <td width="70px" class="numerico"><?php echo number_format($det->pro_descuento,$dec)?></td>
                        <td width="70px" class="numerico"><?php echo number_format($det->precio_tot,$dec)?></td>
                    </tr>
                    <?php
                     } 
                    ?> 
