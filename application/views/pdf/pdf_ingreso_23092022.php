            ...
            <table id="encabezado1" width="100%">
                <tr>
                    <td rowspan="4" width="20%">
                        <img src="<?php echo base_url().'imagenes/'.$ingreso->emp_logo?>" width="150px" height="80px">
                    </td>
                    <th class="titulo" width="80%"><?php echo $ingreso->emi_nombre?></th>
                </tr>
                <tr>
                ...
                <tr>
                    <th></th>                    
                    <th class="titulo" style="text-align: right;">Documento N°: <?php echo $ingreso->mov_documento?></th>
                </tr>
                <tr>
                    <th></th>
                    <td style="text-align: right;"><strong>Fecha de Emision:</strong> <?php echo $ingreso->mov_fecha_trans?></td>
                </tr>     
                <tr>
                    <td><br><br></td>
                </tr>  
    ...
    <tr>
        <td colspan="3">
            <table id="encabezado2" width="100%">
                ...
                <tr>
                    <td><strong>Documento/Información:</strong> <?php echo $ingreso->mov_guia_transporte?></td>
                </tr>    
                <tr>
                    <td><strong>Transaccion:</strong> <?php echo $ingreso->trs_descripcion?></td>
                </tr> 
