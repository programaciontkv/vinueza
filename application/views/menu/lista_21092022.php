...
<section class="content">
	<div class="box box-solid">
		<div class="box box-body">
			<div class="row">
				<div class="col-md-12">
					<a href="<?php echo base_url();?>menu/nuevo" class="btn btn-primary btn-flat"><span class="fa fa-plus"></span> Nuevo</a>
				</div>	
			</div>
			<br>
			<div class="row">
							...
							<tr>
								...
								<td align="center">
									<div class="btn-group">
										...
										?>
										<a href="<?php echo base_url();?>menu/editar/<?php echo $menu->men_id?>" class="btn btn-primary"> <span class="fa fa-edit"></span></a>
										<?php 
										}
										if($permisos->rop_eliminar){
										?>
										<a href="<?php echo base_url();?>menu/eliminar/<?php echo $menu->men_id?>/<?php echo $menu->men_nombre?>" class="btn btn-danger btn-remove"><span class="fa fa-trash"></span></a>
										<?php 
										}
										?>
									</div>
