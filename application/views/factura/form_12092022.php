                    ...
                    <tr>
                      <td class="col-sm-6">
                        ...
                        <div class="panel panel-success col-sm-12">
                          ...
                          <div class="row">
                               <div class="col-md-3">
                                 <input type="button" class="btn btn-primary" onclick="verificar_cedula('9999999999999')"  name="" value="Consumidor final ">
                              </div>

                              <div class="col-md-2">
                                <input type="button" class="btn btn-success" onclick="datos()"  name="" value="Con Datos">
                              </div>

                              <div class="col-md-2">
                                <input type="button" class="btn btn-info" onclick="pas()"  name="" value="Extranjero">
                              </div>
                            </div>
                            <br>
                        ...
                        <table class="table">
                          ...
                          <table class="table table-bordered table-striped" id="tbl_pagos">
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td width="200">
                                  <input type="text" id="pag_descripcion1" name="pag_descripcion1"  class="form-control itm" size="15px" lang="1" list="list_formas" onchange="traer_forma(this)">
                                ...
                                <td><input type="text" id="pag_cantidad1" name="pag_cantidad1" class="form-control" size="10px" lang="1" onchange="calculo_pagos(this)"></td>
                                <?php 
                                  if($m_pag==0){
                                  ?>
