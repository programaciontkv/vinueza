              ...
              <div class="box-body" >
                 <table class="table col-sm-12" border="0">
                    ...
                    <tr>
                      <td class="col-sm-2">
                        <div class="box-body">
                        <div class="panel panel-success col-sm-11">
                        ...
                        <table class="table">
                          ...
                          <table class="table table-bordered table-striped" id="tbl_pagos">
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td width="350">
                                  <input type="text" id="pag_descripcion1" name="pag_descripcion1"  class="form-control itm" size="15px" lang="1" list="list_formas" onchange="traer_forma(this),busqueda_ntscre(this)">
                                ...
                                <td width="190"><input type="text" id="pag_documento1" name="pag_documento1" class="form-control" size="15px" lang="1" list="list_notas" onchange="load_notas_credito(this)">
                            ...
                            <tfoot>
                            <tr>
                              <td colspan="5"><label>Faltante</label></td>
        ...
        obj.value = (obj.value + '').replace(/[^0-9.]/g, '');
            ...
            function calculo_pagos(obj){
              ...
              var pg_ac=0;
                ...
                falt=parseFloat (tv)- parseFloat( pg_ac);
          ...
          function traer_forma(obj){
              ...
              $.ajax({
                    ...
                    success: function (dt) {
                        if(dt!=""){
                          ...
                          alert('Forma de pago no existe');
                          $('#pag_plazo'+n).html("<option value='0'>SELECCIONE</option>");
                        } 
                       habilitar(obj); 
                    },
                    error : function(xhr, status) {
            ...
            function habilitar(obj) {
                ...
                if ($('#pag_tipo' + s).val() == '1') {
                    ...
                    $('#pag_banco' + s).attr('disabled', false);
                    $('#pag_tarjeta' + s).attr('disabled', false);
                    $('#pag_banco' + s).focus();
                    ...
                    $('#pag_plazo' + s).attr('disabled', true);
                    $('#pag_banco' + s).attr('disabled', false);
                    $('#pag_tarjeta' + s).attr('disabled', true);
                    $('#pag_banco' + s).focus();

                } else if ($('#pag_tipo' + s).val() == '9') {
                    $('#pag_cantidad' + s).attr('readonly', false);
                    $('#pag_plazo' + s).attr('disabled', false);
                    $('#pag_banco' + s).attr('disabled', true);
                    $('#pag_tarjeta' + s).attr('disabled', true);
                    $('#pag_plazo' + s).focus();
                } 
