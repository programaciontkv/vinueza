		...
		<div class="box box-body">
			...
			<div class="row">
				<div class="col-md-12">
					...
					?>
						<a href="<?php echo base_url();?>otro/nuevo" class="btn btn-primary btn-flat"><span class="fa fa-plus"></span> Nuevo</a>
					<?php 
					}
					?>
				</div>	
							...
							<tr>
								...
								<td align="center">
									<div class="btn-group">
										...
										?>
											<a href="<?php echo base_url();?>otro/editar/<?php echo $producto->id?>" class="btn btn-primary"> <span class="fa fa-edit"></span></a>
										<?php 
										}
