		...
		<div class="box box-body">
			...
			<div class="row">
				<div class="col-md-2">
					...
					?>
						<a href="<?php echo base_url();?>guia_remision/nuevo/<?php echo $permisos->opc_id?>" class="btn btn-success btn-flat"><span class="fa fa-plus"></span> Crear Guía de Remisión</a>
					<?php 
					}
					?>
				</div>
