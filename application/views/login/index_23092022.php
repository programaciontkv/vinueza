            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="row">
                  <div class="col-md-12">
                    <b>Ruc/C.I:</b>
                    <input type="text" class="form-control" placeholder="Identificación"  name="cliente" id="cliente">
                  </div>
                  <div class="col-md-12">
                   <b> Clave de Acceso: </b>
                    <input type="text" class="form-control" placeholder="Clave de acceso"  name="clave" id="clave">
     ...
     $.ajax({       
                  beforeSend: function () {
                        ...
                        if ($('#clave').val().length == 0) {
                              ...
                              swal("Error!", "Ingrese la clave de acceso!", "error");
