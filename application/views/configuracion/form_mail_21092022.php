            ...
            <form role="form" action="<?php echo $action?>" method="post" autocomplete="off">
              <div class="box-body">
                <div class="form-group <?php if(form_error('secure')!=''){ echo 'has-error';}?> ">
                  ...
                  <input type="text" class="form-control" name="secure" value="<?php if(validation_errors()!=''){ echo set_value('secure');}else{ echo $dt[0];}?>">
                  <?php echo form_error("secure","<span class='help-block'>","</span>");?>
                </div>
                <div class="form-group <?php if(form_error('puerto')!=''){ echo 'has-error';}?> ">
                  <label>Puerto:</label>
                  <input type="text" class="form-control" name="puerto" value="<?php if(validation_errors()!=''){ echo set_value('puerto');}else{ echo $dt[1];}?>">
                  <?php echo form_error("puerto","<span class='help-block'>","</span>");?>
                </div>
                <div class="form-group <?php if(form_error('host')!=''){ echo 'has-error';}?> ">
                  <label>Host:</label>
                  <input type="text" class="form-control" name="host" value="<?php if(validation_errors()!=''){ echo  set_value('host');}else{echo $dt[2];}?>" style="text-transform:lowercase;">
                  <?php echo form_error("host","<span class='help-block'>","</span>");?>
                </div>
                <div class="form-group <?php if(form_error('usuario')!=''){ echo 'has-error';}?> ">
                  <label>Nombre del Usuario:</label>
                  <input type="email" class="form-control" name="usuario" value="<?php if(validation_errors()!=''){ echo  set_value('usuario');}else{echo $dt[3];}?>" style="text-transform:lowercase;">
                ...
                <div class="form-group <?php if(form_error('contrasena')!=''){ echo 'has-error';}?> ">
                  ...
                  <input type="password" class="form-control" name="contrasena" value="<?php if(validation_errors()!=''){ echo set_value('contrasena');}else{ echo $dt[4];}?>">
                ...
                <div class="form-group <?php if(form_error('emisor')!=''){ echo 'has-error';}?> ">
                  ...
                  <input type="text" class="form-control" name="emisor" value="<?php if(validation_errors()!=''){ echo  set_value('emisor');}else{echo $dt[5];}?>">
