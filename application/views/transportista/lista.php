				...
				<div class="col-md-12">
					<table id="tbl_list" class="table table-bordered table-list table-hover" style="margin-left:-22px">
						...
						<!-- 	<th>No</th> -->
							...
							<th class="hidden-mobile">Direccion</th>
						...
						?>
							<tr>
								...
								<td class="hidden-mobile" style="mso-number-format:'@'"><?php echo $transportista->tra_placa?></td>
								<td class="hidden-mobile"><?php echo $transportista->tra_direccion?></td>
								<td class="hidden-mobile"><?php echo $transportista->tra_telefono?></td>
								...
								<td>
									 ...
									 <img width="40px" height="40px" onclick="cambiar_es(2,<?php echo $transportista->tra_id?>)" src="../imagenes/activo.png"> 
								...
								?>
								<td>
									 <img width="40px" height="40px" onclick="cambiar_es(1,<?php echo $transportista->tra_id?>)" src="../imagenes/inactivo.png"> 
								...
								<td align="center">
									<div class="btn-group">
										...
										?>
											<a href="<?php echo base_url();?>transportista/editar/<?php echo $transportista->tra_id?>/<?php echo $permisos->opc_id?>" class="btn btn-primary"> <span class="fa fa-edit"></span></a>
										<?php 
										}
