				...
				<div class="col-md-10">
					...
					<table width="100%">
						<tr>
							...
							<td><input type="text" id='txt' name='txt' class="form-control" style="width: 150px" value='<?php echo $txt?>' placeholder="Factura/Producto/Cliente"/></td>
