                      ...
                      <td class="col-sm-6">
                        <table class="table">
                          <tr>
                              ...
                              <td><label>Guia de Recepcion:</label></td>
                              <td>
                              <div class="form-group <?php if(form_error('mov_guia_transporte')!=''){ echo 'has-error';}?> ">
                                <input type="text" class="form-control" name="mov_guia_transporte" id="mov_guia_transporte" value="<?php if(validation_errors()!=''){ echo set_value('mov_guia_transporte');}else{ echo $movimiento->mov_guia_transporte;}?>">
                          ...
                          <tr>
                              ...
                              <td>
                                <div class="form-group ">
                                  <select name="trs_id"  id="trs_id" class="form-control" onchange="seleccion()">
                                    <option value="">SELECCIONE</option>
                                     <?php
                                    if(!empty($transacciones)){
                                      foreach ($transacciones as $transaccion) {
                                    ?>
                                    <option value="<?php echo $transaccion->trs_operacion.$transaccion->trs_id?>"><?php echo $transaccion->trs_descripcion?></option>
                                    <?php
                                      }
                                    }
                                  ?>
                              ...
                              <div class="form-group <?php if(form_error('cli_nombre')!=''){ echo 'has-error';}?> ">
                                <input type="text" class="form-control" name="cli_nombre" id="cli_nombre" value="<?php if(validation_errors()!=''){ echo set_value('cli_nombre');}else{ echo $movimiento->cli_nombre;}?>" list='list_clientes' onchange="traer_cliente()">
                          ...
                          <table class="table table-bordered table-striped" id="tbl_detalle">
                            ...
                            <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input style="text-align:left " type="text" style="width:  300px;" class="form-control" id="pro_codigo" name="pro_codigo"  lang="1"   maxlength="16"  list="productos" onchange="load_producto(this.lang)" readonly/>
                                        </td>
                                        <td>
