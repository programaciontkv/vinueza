                          ...
                          <table class="table table-bordered table-striped" id="tbl_pagos">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td><input type="text" id="pag_cantidad1" name="pag_cantidad1" class="form-control" size="10px" lang="1" onchange="calculo_pagos(this)" value="<?php echo str_replace(',', '', number_format($factura->pag_cantidad1, $dec))?>"readonly></td>
                                <?php 
                                  if($m_pag==0){
                                  ?>
                                ...
                                <td><input type="text" id="pag_cantidad<?php echo $m?>" name="pag_cantidad<?php echo $m?>" class="form-control" size="10px" lang="<?php echo $m?>" onchange="calculo_pagos(this)" <?php echo $read_cnt?> value="<?php echo $rst_pag->pag_cant?>"></td>
                                <?php 
                                  if($m_pag==0){
                                  ?>
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <td valign="top" rowspan="11" colspan="<?php echo $col_obs?>">
                                      <textarea id="observacion" name="observacion" class="form-control"  onkeydown="return enter(event)"><?php echo $factura->fac_observaciones ?></textarea>
                                    </td>    
