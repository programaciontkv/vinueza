...
<section class="content-header">
	<form id="exp_excel" style="float:right;padding:0px;margin: 0px;" method="post" action="<?php echo base_url();?>consignacion_kardex/excel/<?php echo $permisos->opc_id?>/<?php echo $fec2?>/<?php echo $fec2?>" onsubmit="return exportar_excel2()"  >
...
<script type="text/javascript">
    ...
    function validar(){
			url="<?php echo base_url();?>consignacion_kardex/show_frame/<?php echo $permisos->opc_id?>";
