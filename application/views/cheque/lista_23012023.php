								...
								<td   align="center">
									<div >
										...
										?>
											...
											<?php 
											if ($cheque->chq_estado_cheque==7 || $cheque->chq_estado_cheque==11 ) {
											?>
											...
											<a href="#" onclick="cambiar_es('<?php echo $cheque->chq_id?>',<?php echo $opc_id?>,12,'PROTESTADO')" class="btn btn-info" title="Protestar Cheque"> 
...
<script type="text/javascript">
	...
	function cambiar_es(id,opc,estado,ley){
