                          ...
                          <div class="panel panel-default col-sm-12">
                            <table class="table table-bordered table-striped" id="tbl_detalle">
                              ...
                              <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td> <input type="text" name="pag_id<?php echo $n?>" id="pag_id<?php echo $n?>" value="<?php echo $factura->pag_id?>">
                    ...
                    <tr>
                      <td class="col-sm-12" >
                        <div class="box-body" class="col-sm-12">
                          <div class="panel panel-default col-sm-12">
                            <form>
                              <div class="panel panel-heading" style="background-color:#d9f6f7"><label>Datos de la cuentas</label></div>
                                ...
                                <tr <?php echo $hidden ?>>
                                  ...
                                  <td>
                                    ...
                                    if(empty($cuenta)){
                                      ...
                                      $pln_descripcion=$cuenta->pln_descripcion;
                                    }
                                    ?>
    ...
    <script>
      ...
      function total() {
            ...
            function validar(){
              ...
              if($('#t_cobro').html()>0 && ($("#chq_cta_abono").val().length==0)){
