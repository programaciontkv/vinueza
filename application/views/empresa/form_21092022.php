            ...
            <form role="form" action="<?php echo $action?>" method="post" autocomplete="off">
              <div class="box-body">
                <div class="form-group <?php if(form_error('emp_identificacion')!=''){ echo 'has-error';}?> col-md-6">
                  <label>RUC:</label>
                  <input type="text" class="form-control" name="emp_identificacion" id="emp_identificacion" value="<?php if(validation_errors()!=''){ echo set_value('emp_identificacion');}else{ echo $empresa->emp_identificacion;}?>" onchange="verificar_cedula(this)">
                ...
                <div class="form-group <?php if(form_error('emp_nombre')!=''){ echo 'has-error';}?> col-md-6">
                  ...
                  <input type="text" class="form-control" name="emp_nombre" value="<?php if(validation_errors()!=''){ echo set_value('emp_nombre');}else{ echo $empresa->emp_nombre;}?>">
                ...
                <div class="form-group col-md-6">
                  <label>Estado</label>
                  <select name="emp_estado"  id="emp_estado" class="form-control">
                    <?php
                    if(!empty($estados)){
