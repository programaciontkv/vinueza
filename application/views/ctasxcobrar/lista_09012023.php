				...
				<div class="col-md-12">
					...
					<table width="100%">
						<tr>
							...
							<td>
								<button type="buttom" class="btn btn-danger" onclick="envio(3)" title="Reporte Cartera vencida">Cartera vencida</button>
							</td>
							<td>
					...
					<table id="tbl_list" class="table table-bordered table-list table-hover" width="100%">
						...
						?>		
							...
							<tr>
								...
								<td><a href="#" onclick="envio(8,'<?php echo $factura->fac_identificacion?>')" class="btn btn-danger" title="Reporte Estado de Cobros">Estado Cobros</a></td>
							</tr>
						<?php		
							}
						?>
							...
							<tr <?php echo $estado?>>
								...
								<td align="center">
									<div class="btn-group">
										...
										?>
										<a href="#" onclick="envio(6,'<?php echo $factura->fac_id?>')" class="btn btn-danger" title="Detalle"> <span class="fa fa-file-pdf-o" ></span></a>
