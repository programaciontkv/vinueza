                    ...
                    <tr>
                       <td colspan="2"><label>Fecha Emision:</label></td>
                        ...
                        <div class="form-group <?php if(form_error('reg_femision')!=''){ echo 'has-error';}?> ">
                                <input type="date" class="form-control" name="reg_femision" id="reg_femision" value="<?php if(validation_errors()!=''){ echo set_value('reg_femision');}else{ echo $factura->reg_femision;}?>" <?php echo $read_ret?> <?php echo $read_cxp?> onchange="calculo_fecha()">
                    ...
                    <tr>
                      ...
                      <td >
                        <div class="form-group <?php if(form_error('reg_ruc_cliente')!=''){ echo 'has-error';}?> ">
                          <input type="text" class="form-control" name="reg_ruc_cliente" id="reg_ruc_cliente" value="<?php if(validation_errors()!=''){ echo set_value('reg_ruc_cliente');}else{ echo $factura->cli_ced_ruc;}?>" list="list_clientes" onchange="traer_cliente(this)" <?php echo $read_ret ?> <?php echo $read_cxp?>>
                    ...
                    <tr>
                      ...
                      <td >
                        <div class="form-group <?php if(form_error('telefono_cliente')!=''){ echo 'has-error';}?> ">
                          <input type="text" class="form-control" name="telefono_cliente" id="telefono_cliente" value="<?php if(form_error('telefono_cliente')){ echo set_value('telefono_cliente');}else{ echo $factura->cli_telefono;}?>" <?php echo $read_ret ?> <?php echo $read_cxp?>>
