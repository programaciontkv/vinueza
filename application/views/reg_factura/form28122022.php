            ...
            <table class="table col-sm-10" border="0">
              <tr>
                <td class="col-sm-5">
                  ...
                  <table class="table">
                    <tr>
                      <td colspan="2" ><label>Fecha Registro:</label></td>
                      <td>
                  ...
                  <tr>
                    ...
                    <td >
                      <div class="form-group <?php if(form_error('reg_num_documento')!=''){ echo 'has-error';}?>">
                                <input  type="hidden" class="form-control documento" name="reg_num_documento" id="reg_num_documento" value="<?php if(validation_errors()!=''){ echo set_value('reg_num_documento');}else{ echo $factura->reg_num_documento;}?>" onchange="num_factura(this)" maxlength="17" <?php echo $read_ret ?>>
                      ...
                      ?>  
                        ...
                        <div class="row">
                             ...
                             <div class="col-xs-3">
                          <input type="text" class="form-control" id="reg_num_documento0" size="3" maxlength="3" value="<?php echo $dn[0] ?>" onkeyup=" this.value = this.value.replace(/[^0-9]/, '')" onchange="completar_ceros(this, 0)"/>
                        </div>
                      <div class="col-xs-1" style="width: 0.5%;"> <p>-</p> </div> 
                          <div class="col-xs-3">
                            <input type="text"  class="form-control" id="reg_num_documento1"  maxlength="3" value="<?php echo $dn[1] ?>" onkeyup=" this.value = this.value.replace(/[^0-9]/, '')" onchange="completar_ceros(this, 0)" />
                          </div>
                          <div class="col-xs-1" style="width: 1%;"> <p>-</p> </div> 
                        <div class="col-xs-4">
                          <input type="text"  class="form-control" id="reg_num_documento2"  maxlength="9" value="<?php echo $dn[2] ?>" onkeyup=" this.value = this.value.replace(/[^0-9]/, '')" onchange="completar_ceros(this, 1)" />
                        </div>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <div class="form-group <?php if(form_error('reg_femision')!=''){ echo 'has-error';}?> ">
                                <input type="date" class="form-control" name="reg_femision" id="reg_femision" value="<?php if(validation_errors()!=''){ echo set_value('reg_femision');}else{ echo $factura->reg_femision;}?>" <?php echo $read_ret ?> onchange="calculo_fecha()">
