                      ...
                      ?>
                       <td colspan="2"><label>Fecha Emision:</label></td>
                        ...
                        <div class="form-group <?php if(form_error('reg_femision')!=''){ echo 'has-error';}?> ">
                                <input type="date" max="<?php echo $min ?>" class="form-control" name="reg_femision" id="reg_femision" value="<?php if(validation_errors()!=''){ echo set_value('reg_femision');}else{ echo $factura->reg_femision;}?>" <?php echo $read_ret?> <?php echo $read_cxp?> onchange="calculo_fecha()">
            ...
            function validar(opc){
              if(opc==0){
                if($('#cantidad').val().length!=0 && $('#reg_codigo_cta').val().length!=0  && parseFloat($('#cantidad').val())>0 && $('#pro_precio').val().length!=0 &&  parseFloat($('#pro_precio').val())>0 && $('#descuento').val().length!=0 && $('#pro_descripcion').val().length!=0){
                  ...
                  if($('#reg_codigo_cta').val().length!=0){
