...
<section class="content">
                        ...
                        <div class="panel panel-default col-sm-12">
                          ...
                          <tr>
                              ...
                              <div class="form-group <?php if(form_error('reg_femision')!=''){ echo 'has-error';}?> ">
                                <input type="date" class="form-control" name="reg_femision" id="reg_femision" value="<?php if(validation_errors()!=''){ echo set_value('reg_femision');}else{ echo $factura->reg_femision;}?>">
                          ...
                          <tr>
                            ...
                            <td >
                              <div class="form-group <?php if(form_error('reg_num_documento')!=''){ echo 'has-error';}?> ">
                                <input type="text" class="form-control documento" name="reg_num_documento" id="reg_num_documento" value="<?php if(validation_errors()!=''){ echo set_value('reg_num_documento');}else{ echo $factura->reg_num_documento;}?>" onchange="num_factura(this)" maxlength="17">
                            ...
                            <tr>
                                ...
                                <td >
                                  <div class="form-group <?php if(form_error('reg_ruc_cliente')!=''){ echo 'has-error';}?> ">
                                    <input type="text" class="form-control" name="reg_ruc_cliente" id="reg_ruc_cliente" value="<?php if(validation_errors()!=''){ echo set_value('reg_ruc_cliente');}else{ echo $factura->cli_ced_ruc;}?>" list="list_clientes" onchange="traer_cliente(this)">
                            ...
                            <tr>
                              ...
                              <td >
                                <div class="form-group <?php if(form_error('nombre')!=''){ echo 'has-error';}?> ">
                                  <input type="text" class="form-control" name="nombre" id="nombre" value="<?php if(validation_errors()!=''){ echo set_value('nombre');}else{ echo $factura->cli_raz_social;}?>" >
                            ...
                            <tr>
                              ...
                              <td >
                                <div class="form-group <?php if(form_error('direccion_cliente')!=''){ echo 'has-error';}?> ">
                                  <input type="text" class="form-control" name="direccion_cliente" id="direccion_cliente" value="<?php if(validation_errors()!=''){ echo set_value('direccion_cliente');}else{ echo $factura->cli_calle_prin;}?>">
                              ...
                              <tr>
                                ...
                                <td >
                                  <div class="form-group <?php if(form_error('telefono_cliente')!=''){ echo 'has-error';}?> ">
                                    <input type="text" class="form-control" name="telefono_cliente" id="telefono_cliente" value="<?php if(form_error('telefono_cliente')){ echo set_value('telefono_cliente');}else{ echo $factura->cli_telefono;}?>">
                              ...
                              <tr>
                                ...
                                <td >
                                  <div class="form-group <?php if(form_error('email_cliente')!=''){ echo 'has-error';}?> ">
                                    <input type="email" class="form-control" name="email_cliente" id="email_cliente" value="<?php if(validation_errors()!=''){ echo set_value('email_cliente');}else{ echo $factura->cli_email;}?>">
                          ...
                          <table class="table table-bordered table-striped" id="tbl_detalle">
                                   ...
                                   ?>
                                    <tr>
                                      <td align="center" ><input  type="button" name="nuevo" id="nuevo" class="btn btn-success" onclick="habilitar(0)" lang="1" value='NUEVO'/> </td>
                                        <td>
                                          <input type="hidden" name="pro_cat" id="pro_cat">
                                          <select name="pro_ids" id="pro_ids" style="width: 150px" disabled class="form-control sel">
                                            <option value="0">SELECCIONE</option>
                                            <?php 
                                            ...
                                            ?>
                                            <option value="<?php echo $rst_ct->ids?>"><?php echo strtoupper($dt[9])?></option>
                                            <?php
                                              }
                                            }
                                            ?>
                                        ...
                                        <td>
                                          <input type="hidden" name="pro_a" id="pro_a">
                                          <select name="mp_a" id="mp_a" onchange="load_tipos()" style="width: 150px" disabled class="form-control  sel">
                                            <option value="0">SELECCIONE</option>
                                            <?php 
                                            if(!empty($familias)){
                                        ...
                                        <td>
                                          <input type="hidden" name="pro_b" id="pro_b">
                                          <select name="mp_b" id="mp_b" style="width: 150px" disabled class="form-control  sel">
                                            <option value="0">SELECCIONE</option>
                                            <?php 
                                            if(!empty($tipos)){
                                        ...
                                        <td>
                                            <input style="text-align:left " type="text" style="width:  3000px;" class="form-control" id="pro_descripcion" name="pro_descripcion"  value="" lang="1"   maxlength="16" list="productos" onchange="load_producto(this.lang)"  />
                                        </td>
                                        <td>
                                  ...
                                  $n=0;
                                    foreach($cns_det as $rst_det) {
                                        ...
                                        <tr>
                                            ...
                                            <td id="pro_cat<?PHP echo $n ?>" name="categoria<?PHP echo $n ?>" lang="<?PHP echo $n ?>"><?PHP echo strtoupper($rst_det->categoria) ?></td>
                                            <td id="mp_a<?PHP echo $n ?>" name="familia<?PHP echo $n ?>" lang="<?PHP echo $n ?>" ><?PHP echo $rst_det->mp_a ?></td>
                                            <td id="mp_b<?PHP echo $n ?>" name="tipo<?PHP echo $n ?>" lang="<?PHP echo $n ?>" ><?PHP echo $rst_det->mp_b ?></td>
                                            ...
                                            <td ><input type ="text" size="7"  style="text-align:right" class="form-control decimal" id="<?php echo 'cantidad' . $n ?>" name="<?php echo 'cantidad' . $n ?>" value="<?php echo str_replace(',', '', number_format($rst_det->cantidad, $dec)) ?>" lang="<?PHP echo $n ?>" onchange="calculo(this)" onkeyup="this.value = this.value.replace(/[^0-9.]/, '')"  /></td>
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control" id="total_propina" name="total_propina" value="<?php echo str_replace(',', '', number_format($factura->reg_propina, $dec)) ?>"  style="text-align:right" onchange="calculo()"/>
    ...
    <script >
            ...
            function clona_detalle(table,opc) {
                ...
                if (d == 0) {
                    ...
                    var fila = "<tr>"+
                                        ...
                                        "</td>"+
                                        "<td id='pro_cat"+i+"' lang='"+i+"'>"+pro_cat.value+"</td>"+
                                        "<td id='mp_a"+i+"' lang='"+i+"'>"+pro_a.value+"</td>"+
                                        "<td id='mp_b"+i+"' lang='"+i+"'>"+pro_b.value+"</td>"+
      ...
      function habilitar(op){
        if(op==0){
          $('#nuevo').prop('class','btn btn-danger');
          $('#pro_ids').prop('disabled',false);
          $('#mp_a').prop('disabled',false);
          $('#mp_b').prop('disabled',false);
          $('#pro_referencia').prop('readonly',false);
          $('#unidad').prop('disabled',false);
          $('#pro_descripcion').attr('list','');
          $('#pro_descripcion').attr('onchange','load_codigo()');
          $('#add1').attr('onclick','validar(1)');
          $('#pro_ids').val('0');
          $('#pro_cat').val('');
          $('#mp_a').val('0');
          $('#pro_a').val('');
          ...
          $('#nuevo').prop('class','btn btn-success');
          $('#pro_ids').prop('disabled',true);
          $('#mp_a').prop('disabled',true);
          $('#mp_b').prop('disabled',true);
          $('#pro_referencia').prop('readonly',true);
          $('#unidad').prop('disabled',true);
          $('#pro_descripcion').attr('list','productos');
          $('#pro_descripcion').attr('onchange','load_producto()');
          $('#add1').attr('onclick','validar(0)');
          validar(0);
        } 
      }     

      function load_tipos(){
            uri=base_url+'reg_factura/traer_tipos/'+$('#mp_a').val();
            $.ajax({
                    url: uri,
                    type: 'POST',
                    success: function(dt){
      ...
      function nuevo_producto(){
        ...
        var data={
          ...
          'mp_a':$('#mp_a').val(),
          "mp_b": $('#mp_b').val(),
          "mp_c": $('#pro_descripcion').val(),
          "mp_d": $('#pro_referencia').val(),
          "mp_q": $('#unidad').val(),
          "mp_e": $('#pro_precio').val(),
          "mp_h": $('#iva').val()
                ...
                $.ajax({
                  beforeSend: function () {
                      if ($("#pro_ids").val() == '0') {
                        ...
                        $("#mp_b").focus();
                        return false;
                      } else if ($("#pro_descripcion").val().length == 0) {
                        $("#pro_descripcion").css({borderColor: "red"});
                        $("#pro_descripcion").focus();
                        return false;
                      } else if ($("#pro_referencia").val().length == 0) {
                        $("#pro_referencia").css({borderColor: "red"});
                        $("#pro_referencia").focus();
                        return false;
                      } else if ($("#unidad").val().length == 0) {
                        $("#unidad").css({borderColor: "red"});
                        $("#unidad").focus();
                        return false;
                      } else if ($("#cantidad").val().length == 0 && parseFloat($('#cantidad').val())==0) {
                        $("#cantidad").css({borderColor: "red"});
                        $("#cantidad").focus();
                        return false;
                      } else if ($("#pro_precio").val().length == 0 && parseFloat($('#pro_precio').val())==0) {
                        $("#pro_precio").css({borderColor: "red"});
                        $("#pro_precio").focus();
                        return false;
                      } else if ($("#descuento").val().length == 0) {
