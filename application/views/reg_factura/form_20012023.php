      ...
      function validar_decimal(obj){
        obj.value = (obj.value + '').replace(/[^0-9.]/g, '');
            ...
            function validar(opc){
              if(opc==0){
                if($('#cantidad').val().length!=0 && $('#reg_codigo_cta').val().length!=0  && parseFloat($('#cantidad').val())>0 && $('#pro_precio').val().length!=0 &&  parseFloat($('#pro_precio').val())>0 && $('#descuento').val().length!=0 && $('#pro_descripcion').val().length!=0){
                  clona_detalle();
                }else{
