		...
		<div class="box box-body">
			...
			<div class="row">
				<div class="col-md-12">
					...
					?>
						<a href="<?php echo base_url();?>servicio/nuevo" class="btn btn-success btn-flat"><span class="fa fa-plus"></span> Crear servicio </a>
					<?php 
					}
					?>
				</div>	
							...
							<tr>
								...
								<td align="center">
									<div class="btn-group">
										...
										?>
											<a href="<?php echo base_url();?>servicio/editar/<?php echo $producto->id?>" title="Editar servicio " class="btn btn-primary"> <span class="fa fa-edit"></span></a>
										<?php 
										}
