            ...
            <form role="form" action="<?php echo $action?>" method="post" autocomplete="off">
              <div class="box-body">
                ...
                <div class="form-group <?php if(form_error('usu_login')!=''){echo 'has-error';}?>">
                  <label>Usuario:</label>
                  <input type="text" <?php echo $etq ?>   class="form-control" name="usu_login" id="usu_login" placeholder="Usuario" value="<?php if(validation_errors()!=''){ echo set_value('usu_login');}else{echo  $usuario->usu_login;}?>">
