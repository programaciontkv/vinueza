        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <form role="form" action="<?php echo $action?>" method="post" autocomplete="off">
              <div class="box-body">
                <div class="form-group <?php echo !empty(form_error('usu_login'))? 'has-error' : '';?>">
                  <label>Usuario:</label>
                  <input type="text" class="form-control" name="usu_login" id="usu_login" placeholder="Usuario" value="<?php echo !empty(validation_errors())? set_value('usu_login') :  $usuario->usu_login;?>" readonly>
                  <?php echo form_error("usu_login","<span class='help-block'>","</span>");?>
                </div>
                <div class="form-group <?php echo !empty(form_error('usu_imagen'))? 'has-error' : '';?>">
                ...
                ?>
                  ...
                  <input type="text" hidden name="usu_imagen" id="usu_imagen" value="<?php echo !empty(form_error('usu_imagen'))? set_value('usu_imagen') :  $usuario->usu_imagen;?>" onchange="uploadAjax()">
                  <input type="file" name="direccion" id="direccion"  onchange="uploadAjax()">
                  <?php echo form_error("usu_imagen","<span class='help-block'>","</span>");?>
                </div>
                
                <div class="form-group <?php echo !empty(form_error('usu_pass'))? 'has-error' : '';?>">
                ...
                <div class="form-group <?php echo !empty(form_error('usu_pass2'))? 'has-error' : '';?>">
