...
<section class="content">
            ...
            <form role="form" action="<?php echo $action?>" method="post" autocomplete="off">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="radio" name="tps_relacion" id="tps_relacion1" <?php echo $sel_ct1?> onclick="mostrar()" value='1'>
                  <br>
                  <label>Tipo (Sub Nivel 2 ):</label>
                  <input type="radio" name="tps_relacion" id="tps_relacion2" <?php echo $sel_ct2?> onclick="mostrar()" value='2'>
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url();?>tipo" class="btn btn-default">Cancelar</a>
              </div>
    ...
    <script type="text/javascript">
      ...
      function g_siglas(){
        ...
        $('#tps_siglas').val(dato.substr(0,3));
      }
