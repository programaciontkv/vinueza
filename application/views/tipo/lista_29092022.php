						...
						?>
							...
							<!-- 	<td><?php echo $tipo->tps_densidad?></td> -->
								...
								<td>
									 ...
									 <img title="Inactivar Categoria" width="25px" height="25px" onclick="cambiar_es(2,<?php echo $tipo->tps_id?>)" src="../imagenes/activo.png"> 
								...
								?>
								<td>
									 <img title="Activar Categoria" width="25px" height="25px" onclick="cambiar_es(1,<?php echo $tipo->tps_id?>)" src="../imagenes/inactivo.png"> 
								...
								<td align="center">
									<div class="btn-group">
										...
										?>
											<button title="Ver detalles" type="button" class="btn btn-info btn-view" data-toggle="modal" data-target="#modal-default" value="<?php echo base_url();?>tipo/visualizar/<?php echo $tipo->tps_id?>"><span class="fa fa-eye"></span>
								            </button>
							            <?php
							        	}
										if($permisos->rop_actualizar){
										?>
											<a  title="Editar Categoria" href="<?php echo base_url();?>tipo/editar/<?php echo $tipo->tps_id?>/<?php echo $permisos->opc_id?>" class="btn btn-primary"> <span class="fa fa-edit"></span></a>
										<?php 
										}
