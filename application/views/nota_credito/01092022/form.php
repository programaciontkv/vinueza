                        ...
                        <table class="table">
                          ...
                          <tr>
                            ...
                            <tr>
                              ...
                              <td >
                                <div class="form-group">
                                  <select name="trs_id"  id="trs_id" class="form-control" onchange="ocultar()">
                                    <!-- <option value="">SELECCIONE</option> -->
                          ...
                          <table class="table table-bordered table-striped" id="tbl_detalle">
                            <thead>
                              <tr>
                                ...
                                <th class="td1" <?php echo $hid_inv?>>Inventario</th>
                                  ...
                                  $n=0;
                                    foreach($cns_det as $rst_det) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="td1" id="inventario<?PHP echo $n ?>" name="inventario<?PHP echo $n ?>" lang="<?PHP echo $n ?>" <?php echo $hid_inv?>  style="text-align:right"><?php echo str_replace(',', '', number_format($rst_det->inventario, $dcc)) ?></td>
            ...
            function ocultar() {
                ...
                if ($('#trs_id').val() == '1') {
                  ...
                  $('#lista').html('');
                    ...
                    var tr = "<tr>"+
                                        ...
                                        "<td class='td1' hidden>"+
                                          "<input type ='text' size='7' id='unidad' name='unidad'  value='' lang='1' readonly class='form-control' />"+
                                        "</td>"+
                                        "<td class='td1' hidden <?php echo $hid_inv?>>"+
                                          "<input type ='text' size='7' id='inventario' name='inventario' value='' lang='1' readonly class='form-control decimal' />"+
                                        "</td>"+
                                        "<td class='td1' hidden>"+
                                          "<input type ='text' size='7'  style='text-align:right' id='cantidadf' name='cantidadf'  value='' lang='1' onchange='calculo_encabezado(this), costo(this)' class='form-control decimal' readonly/>"+
                    ...
                    var clp=$('#valores').attr('colspan')-4;
                  ...
                  $('#lista').html('');
                    ...
                    $('.td1').show();  
                    $('#valores').attr('colspan');
                    var clp=($('#valores').attr('colspan')*1)+4;
                    $('#valores').attr('colspan',clp);
                    $('#lista_encabezado').html(tr);
                    $('#propina').val(parseFloat('0').toFixed(dec));
                    $('#subtotal12').val(parseFloat('0').toFixed(dec));
