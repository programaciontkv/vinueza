								...
								<td align="center">
									<div class="btn-group">
										...
										?>
											...
											<a href="../xml_docs/<?php echo $factura->reg_clave_acceso?>.xml" download="../xml_docs/<?php echo $factura->reg_clave_acceso?>.xml" class="btn btn-info" > <span title="XML">XML</span></a>
										<?php 
										} 
							        	if($permisos->rop_reporte){
										?>
											<a href="<?php echo base_url();?>reg_liquidacion/show_frame/<?php echo $factura->reg_id?>/<?php echo $permisos->opc_id?>" class="btn btn-warning" title="RIDE"> <span class="fa fa-file-pdf-o"></span></a>
										<?php 
										}
	...
	function subir_xml() {
		alert('ok');
                ...
                $.ajax({
                    ...
                    url: base_url+"reg_liquidacion/subir_xml",
                    type: 'POST',
                    contentType: false,
                    data: data,
                    processData: false,
