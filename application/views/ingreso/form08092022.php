                        ...
                        <table class="table">
                          <tr>
                              ...
                              <div class="form-group <?php if(form_error('mov_fecha_trans')!=''){ echo 'has-error';}?> ">
                                ...
                                <input type="text"  class="form-control" name="mov_fecha_trans" id="mov_fecha_trans" value="<?php if(validation_errors()!=''){ echo set_value('mov_fecha_trans');}else{ echo  $ingreso->mov_fecha_trans;}?>" style="width: 250px">
                              ...
                              <td>
                                <div class="form-group ">
                                  <input type="hidden" name="trs_id" id="trs_id" value="<?php echo $ingreso->trs_id?>">
                                  <input type="text" class="form-control" name="trs_descripcion" id="trs_descripcion" value="<?php if(validation_errors()!=''){ echo set_value('trs_descripcion');}else{ echo $ingreso->trs_descripcion;}?>" readonly style="width: 250px">
                                  <?php echo form_error("trs_descripcion","<span class='help-block'>","</span>");?>
                                </div>
                              </td> 
                          ...
                          <tr>
                              ...
                              <div class="form-group <?php if(form_error('cli_nombre')!=''){ echo 'has-error';}?> ">
                                <input type="text" placeholder="Ingrese el Proveedor" class="form-control" name="cli_nombre" id="cli_nombre" value="<?php if(validation_errors()!=''){ echo set_value('cli_nombre');}else{ echo $ingreso->cli_nombre;}?>" list='list_clientes' onchange="traer_cliente()" style="width: 250px">
                                  <?php echo form_error("cli_nombre","<span class='help-block'>","</span>");?>
                                  <input type ="text" id="cli_id" name="cli_id" hidden/></td>
                                </div>
                              </td> 
                            ...
                            <td><label>Tipo de Documento</label></td>
                              <td>
                                <div class="form-group ">
                                  <select name="reg_tipo_documento" id="reg_tipo_documento" class="form-control" onchange="doc_duplicado()" style="width: 250px">
                              ...
                              <td><label>No. Documento Recibido:</label></td>
                              <td>
                              <div class="form-group <?php if(form_error('mov_fac_num_entrega')!=''){ echo 'has-error';}?> ">
                                <input placeholder="Ingrese N° Documento Recibido"  type="text" class="form-control" name="mov_num_fac_entrega" id="mov_num_fac_entrega" value="<?php if(validation_errors()!=''){ echo set_value('mov_fac_num_entrega');}else{ echo $ingreso->mov_num_fac_entrega;}?>" style="width: 250px" onchange="doc_duplicado()" maxlength="17">
                                  <?php echo form_error("mov_fac_num_entrega","<span class='help-block'>","</span>");?>
                                </div>
                              </td>  
                            </tr>
                          </td> 
                          ...
                          <table class="table table-bordered table-striped" id="tbl_detalle">
                            ...
                            <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input style="text-align:left " type="text" style="width:  300px;" class="form-control" id="pro_codigo" name="pro_codigo"  lang="1" placeholder="Ingrese producto"   maxlength="16"  list="productos" onchange="load_producto(this.lang)"/>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                          <input type ="text" size="7" style="text-align:right" id="mov_cantidad" name="mov_cantidad"   value="" lang="1" onchange="costo(this, 1)" class="form-control decimal" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                          <input type ="text" size="7"  style="text-align:right" id="mov_cost_tot" name="mov_cost_tot"  value="" lang="1" onchange="costo(this, 2)" class="form-control decimal"/>
                                        </td>
                                        
                                        <td align="center" ><input  type="button" name="add1" id="add1" class="btn btn-primary fa fa-plus" onclick="validar()" lang="1" value='Agregar'/> </td>
                                    </tr>
    ...
    <script>
      ...
      function traer_cliente(){
            ...
            function clonar() {
                ...
                if (j > 0) {
                    while (n < j) {
                        ...
                        if ($('#pro_id' + n).val() == pro_id.value) {
                            ...
                            tot = cant * round(mov_cost_unit.value,dcc);
                ...
                if (d == 0) {
                    ...
                    var fila = "<tr>"+
                                        ...
                                        "<td>"+
                                          "<input type ='text' class='form-control decimal' size='7' style='text-align:right' id='mov_cantidad"+i+"' name='mov_cantidad"+i+"' lang='"+i+"'   value='"+mov_cantidad.value +"' onkeyup='validar_decimal(this)' onchange='costo_detalle(1)'/>"+
                                        "</td>"+
                                        "<td>"+
                                        ...
                                        "</td>"+
                                        "<td>"+
                                          "<input type ='text' size='7'  style='text-align:right' id='mov_cost_tot"+i+"' name='mov_cost_tot"+i+"'  lang='"+i+"' onchange='costo_detalle(2)' class='form-control decimal' value='"+mov_cost_tot.value+"' onkeyup='validar_decimal(this)'/>"+
                                        "</td>"+
            ...
            function doc_duplicado(){
              num_doc = $('#mov_num_fac_entrega').val();
