                        ...
                        <table class="table">
                          <tr>
                              ...
                              <div class="form-group <?php if(form_error('mov_fecha_trans')!=''){ echo 'has-error';}?> ">
                                ...
                                <input type="hidden" name="cja_id" id="cja_id" value="<?php echo $ingreso->cja_id;?>">
                          ...
                          <tr>
                            ...
                            <tr>
                              ...
                              <td><label>No.Documento Entrega:</label></td>
                              <td >
            ...
            function clonar() {
                ...
                if (d == 0) {
                    ...
                    var fila = "<tr>"+
                                        ...
                                        "<td>"+
                                          "<input type ='text' class='form-control decimal' size='7' style='text-align:right' id='mov_cantidad"+i+"' name='mov_cantidad"+i+"' lang='"+i+"'  value='"+mov_cantidad.value +"' onchange='total()' onkeyup='validar_decimal(this)'/>"+
                                        "</td>"+
                                        "<td>"+
            ...
            function save(){
              ...
              var tr = $('#tbl_detalle').find("tbody tr:last");
                  ...
                  while (n < i) {
                    n++;
                    if($('#mov_cantidad'+n).val()!=null){
                      if($('#mov_cantidad'+n).val().length==0 || parseFloat($('#mov_cantidad'+n).val())==0){
