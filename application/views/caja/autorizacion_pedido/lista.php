					...
					<table id="tbl_list" class="table table-bordered table-list table-hover">
						...
						?>
							<tr>
								...
								<td><?php echo $pedido->ped_ruc_cc_cliente?></td>
								...
								<td align="center">
									...
									?>										
										...
										?>
											<a href="<?php echo base_url();?>autorizacion_pedido/editar/<?php echo $pedido->ped_id?>/<?php echo $opc_id?>" class="btn btn-primary"> <span class="fa fa-edit"></span></a>
										<?php 
										}
										}
										?>
