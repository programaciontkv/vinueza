            ...
            <form role="form" action="<?php echo $action?>" method="post" autocomplete="off">
              <div class="box-body">
               ...
               <div class="form-group <?php if(form_error('cja_sec_factura')!=''){ echo 'has-error';}?> ">
                ...
                <div hidden class="form-group <?php if(form_error('cja_sec_nota_debito')!=''){ echo 'has-error';}?> ">
                ...
                <div class="form-group <?php if(form_error('cja_sec_guia')!=''){ echo 'has-error';}?> ">
                  <label>Secuencial Inicia Guia Remision:</label>
                ...
                <div class="form-group <?php if(form_error('cja_sec_retencion')!=''){ echo 'has-error';}?> ">
                  <label>Secuencial Inicia Retencion:</label>
                ...
                <div class="form-group <?php if(form_error('cja_sec_liquidacion')!=''){ echo 'has-error';}?> ">
                  <label>Secuencial Inicia Liquidacion Compras:</label>
                  <input type="text" class="form-control numerico" name="cja_sec_liquidacion" value="<?php if(validation_errors()!=''){ echo set_value('cja_sec_liquidacion');}else{ echo $caja->cja_sec_liquidacion;}?>">
                  <?php echo form_error("cja_sec_liquidacion","<span class='help-block'>","</span>");?>
                </div>   
